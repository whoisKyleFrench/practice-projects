...
entry_label = tk.Label(
    root, fg=fg_color, text="Please Enter Tasks Below", font=("Arial", 10)
)
entry_label.pack()
...
complete_task_button = tk.Button(
    button_frame, text="Complete", command=lambda: complete_task()
)
...
delete_task_button = tk.Button(
    button_frame, text="Delete", command=lambda: delete_task()
)
